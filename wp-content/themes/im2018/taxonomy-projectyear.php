		...
		<section class="container-fluid">
				<div class="row">
					...
					?>
									...
									<?php echo do_shortcode('[ajax_load_more container_type="div" repeater="template_5" post_type="case_studies" posts_per_page="3" taxonomy="projectyear" taxonomy_terms="'. $current_tax_slug .'" offset="1"]'); ?> 
