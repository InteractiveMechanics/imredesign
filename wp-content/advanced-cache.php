...
} elseif ( ! include_once '/var/www/vhosts/interactivemechanics.com/dev/imredesign/wp-content/plugins/wp-super-cache/' . 'wp-cache-phase1.php' ) {
	if ( ! @is_file('/var/www/vhosts/interactivemechanics.com/dev/imredesign/wp-content/plugins/wp-super-cache/' . 'wp-cache-phase1.php' ) ) {
		define( 'ADVANCEDCACHEPROBLEM', 1 );
	}
}
