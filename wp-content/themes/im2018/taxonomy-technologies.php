	...
	<div class="jumbotron jumbo-short">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-sm-7">
						<h1><?php the_field('case_study_archive_page_heading', 'option'); ?>: <?php echo $current_tax_name; ?></h1>
	...
	<article id="cs-archive">
		<section class="container-fluid">
				<div class="row">
					...
					<?php endwhile; ?>
					<?php echo do_shortcode('[ajax_load_more container_type="div" repeater="template_3" post_type="case_studies" posts_per_page="3" taxonomy="technologies" taxonomy_terms="'. $current_tax_slug . '"  offset="1"]'); ?> 
